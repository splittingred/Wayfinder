...
$cssTpl = '@CODE:<link rel="stylesheet" media="all" type="text/css" href="assets/components/wayfinder/examples/cssplay/flyout.css" />
<!--[if lte IE 6]>
<link rel="stylesheet" media="all" type="text/css" href="assets/components/wayfinder/examples/cssplay/flyout_ie.css" />
<![endif]-->';