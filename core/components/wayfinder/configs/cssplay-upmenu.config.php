...
$cssTpl = '@CODE:<link rel="stylesheet" media="all" type="text/css" href="assets/components/wayfinder/examples/cssplay/upmenu.css" />
<!--[if lte IE 6]>
<link rel="stylesheet" media="all" type="text/css" href="assets/components/wayfinder/examples/cssplay/upmenu_ie.css" />
<![endif]-->';