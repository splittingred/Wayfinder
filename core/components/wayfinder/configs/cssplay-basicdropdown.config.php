...
$cssTpl = '@CODE:<link rel="stylesheet" media="all" type="text/css" href="assets/components/wayfinder/examples/cssplay/basic_dd.css" />
<!--[if lte IE 6]>
<link rel="stylesheet" media="all" type="text/css" href="assets/components/wayfinder/examples/cssplay/basic_dd_ie.css" />
<![endif]-->';