...
$cssTpl = '@CODE:<link rel="stylesheet" media="all" type="text/css" href="assets/components/wayfinder/examples/cssplay/dropline.css" />
<!--[if lte IE 6]>
<link rel="stylesheet" media="all" type="text/css" href="assets/components/wayfinder/examples/cssplay/dropline_ie.css" />
<![endif]-->';